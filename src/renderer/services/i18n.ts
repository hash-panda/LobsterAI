...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    // Candidates
    candidatesTitle: '候选人管理',
    candidatesTabList: '候选人列表',
    candidatesTabSettings: '通知设置',
    candidatesInvite: '邀请候选人',
    candidatesSearchPlaceholder: '搜索姓名或手机号',
    candidatesEmpty: '暂无候选人',
    candidatesStatsTotal: '总计',
    candidatesStatsInvited: '已邀请',
    candidatesStatsInterviewing: '面试中',
    candidatesStatsCompleted: '已完成',
    candidatesStatusAll: '全部',
    candidatesStatusInvited: '已邀请',
    candidatesStatusCheckIn: '已签到',
    candidatesStatusInterviewing: '面试中',
    candidatesStatusCompleted: '已完成',
    candidatesReportTime: '报告时间',
    candidatesStartTime: '开始时间',
    candidatesInviteTime: '邀请时间',
    candidatesViewReport: '查看报告',
    candidatesDelete: '删除',
    candidatesDeleteConfirm: '确定要删除候选人"{name}"吗？',
    // Candidate Detail
    candidatesDetailId: '候选人ID',
    candidatesDetailPhone: '手机号',
    candidatesDetailEmail: '邮箱',
    candidatesDetailPosition: '职位',
    candidatesDetailInterviewCode: '面试间',
    candidatesDetailScore: '评分',
    candidatesDetailAiScore: 'AI 综合评分',
    candidatesDetailDimensions: '维度分析',
    candidatesDetailQuestions: '面试题目',
    candidatesDetailQuestionsMore: '还有 {count} 道题目...',
    candidatesDetailTimeline: '事件时间线',
    candidatesDetailNoEvents: '暂无事件记录',
    candidatesDetailCreatedAt: '创建时间',
    candidatesDetailInterviewUrl: '面试链接',
    candidatesDetailViewFullReport: '查看完整报告',
    candidatesDetailInterviewInfo: '面试信息',
    candidatesDetailInterviewName: '面试名称',
    candidatesDetailDuration: '面试时长',
    candidatesDetailQuestionsCount: '答题情况',
    candidatesDetailLoginTime: '登录时间',
    candidatesDetailBeginTime: '开始时间',
    candidatesDetailSubmitTime: '提交时间',
    candidatesDetailViewRawData: '查看原始数据',
    candidatesDetailRawData: '原始数据',
    // Candidate Form
    candidatesFormTitle: '邀请候选人',
    candidatesFormInterviewCode: '面试间',
    candidatesFormSelectInterview: '请选择面试间',
    candidatesFormName: '姓名',
    candidatesFormNamePlaceholder: '请输入候选人姓名',
    candidatesFormNameRequired: '请输入姓名',
    candidatesFormPhone: '手机号',
    candidatesFormPhonePlaceholder: '请输入手机号',
    candidatesFormPhoneRequired: '请输入手机号',
    candidatesFormPhoneInvalid: '手机号格式不正确',
    candidatesFormEmail: '邮箱',
    candidatesFormEmailPlaceholder: '请输入邮箱（可选）',
    candidatesFormEmailInvalid: '邮箱格式不正确',
    candidatesFormPosition: '职位',
    candidatesFormPositionPlaceholder: '请输入应聘职位（可选）',
    candidatesFormSubmit: '发送邀请',
    candidatesInviteSuccess: '已成功邀请 {name}',
    candidatesInviteError: '邀请失败，请重试',
    // Notification Config
    candidatesNotificationEnabled: '启用通知',
    candidatesNotificationChannels: '通知渠道',
    candidatesNotificationFeishu: '飞书通知',
    candidatesNotificationApp: '应用内通知',
    candidatesNotificationSound: '提示音',
    candidatesNotificationEvents: '事件通知',
    candidatesNotificationOnCheckIn: '签到时通知',
    candidatesNotificationOnStart: '面试开始时通知',
    candidatesNotificationOnEnd: '面试结束时通知',
    candidatesNotificationOnReport: '报告生成时通知',
    candidatesNotificationFeishuChatId: '飞书群聊 ID',
    candidatesNotificationFeishuChatIdPlaceholder: '留空则发送到最近活跃的会话',
    candidatesNotificationFeishuChatIdHint: '指定飞书群聊的 chat_id，通知将发送到该群',
    candidatesNotificationConfigLoadError: '加载配置失败',
  ...
  en: {
    ...
    candidatesTabList: 'Candidates',
    candidatesTabSettings: 'Notifications',
    candidatesInvite: 'Invite Candidate',
    candidatesSearchPlaceholder: 'Search by name or phone',
    candidatesEmpty: 'No candidates',
    candidatesStatsTotal: 'Total',
    candidatesStatsInvited: 'Invited',
    candidatesStatsInterviewing: 'Interviewing',
    candidatesStatsCompleted: 'Completed',
    candidatesStatusAll: 'All',
    candidatesStatusInvited: 'Invited',
    candidatesStatusCheckIn: 'Checked In',
    candidatesStatusInterviewing: 'Interviewing',
    candidatesStatusCompleted: 'Completed',
    candidatesReportTime: 'Report Time',
    candidatesStartTime: 'Start Time',
    candidatesInviteTime: 'Invite Time',
    candidatesViewReport: 'View Report',
    candidatesDelete: 'Delete',
    candidatesDeleteConfirm: 'Are you sure you want to delete candidate "{name}"?',
    // Candidate Detail
    candidatesDetailId: 'Candidate ID',
    candidatesDetailPhone: 'Phone',
    candidatesDetailEmail: 'Email',
    candidatesDetailPosition: 'Position',
    candidatesDetailInterviewCode: 'Interview Code',
    candidatesDetailScore: 'Score',
    candidatesDetailAiScore: 'AI Overall Score',
    candidatesDetailDimensions: 'Dimension Analysis',
    candidatesDetailQuestions: 'Interview Questions',
    candidatesDetailQuestionsMore: '{count} more questions...',
    candidatesDetailTimeline: 'Event Timeline',
    candidatesDetailNoEvents: 'No events recorded',
    candidatesDetailCreatedAt: 'Created At',
    candidatesDetailInterviewUrl: 'Interview Link',
    candidatesDetailViewFullReport: 'View Full Report',
    candidatesDetailInterviewInfo: 'Interview Info',
    candidatesDetailInterviewName: 'Interview Name',
    candidatesDetailDuration: 'Duration',
    candidatesDetailQuestionsCount: 'Questions',
    candidatesDetailLoginTime: 'Login Time',
    candidatesDetailBeginTime: 'Start Time',
    candidatesDetailSubmitTime: 'Submit Time',
    candidatesDetailViewRawData: 'View raw data',
    candidatesDetailRawData: 'Raw Data',
    // Candidate Form
    candidatesFormTitle: 'Invite Candidate',
    candidatesFormInterviewCode: 'Interview Room',
    candidatesFormSelectInterview: 'Select interview room',
    candidatesFormName: 'Name',
    candidatesFormNamePlaceholder: 'Enter candidate name',
    candidatesFormNameRequired: 'Name is required',
    candidatesFormPhone: 'Phone',
    candidatesFormPhonePlaceholder: 'Enter phone number',
    candidatesFormPhoneRequired: 'Phone is required',
    candidatesFormPhoneInvalid: 'Invalid phone number',
    candidatesFormEmail: 'Email',
    candidatesFormEmailPlaceholder: 'Enter email (optional)',
    candidatesFormEmailInvalid: 'Invalid email format',
    candidatesFormPosition: 'Position',
    candidatesFormPositionPlaceholder: 'Enter position (optional)',
    candidatesFormSubmit: 'Send Invite',
    candidatesInviteSuccess: 'Successfully invited {name}',
    candidatesInviteError: 'Failed to invite, please try again',
    // Notification Config
    candidatesNotificationEnabled: 'Enable Notifications',
    candidatesNotificationChannels: 'Notification Channels',
    candidatesNotificationFeishu: 'Feishu Notification',
    candidatesNotificationApp: 'In-App Notification',
    candidatesNotificationSound: 'Sound',
    candidatesNotificationEvents: 'Event Notifications',
    candidatesNotificationOnCheckIn: 'On Check-in',
    candidatesNotificationOnStart: 'On Interview Start',
    candidatesNotificationOnEnd: 'On Interview End',
    candidatesNotificationOnReport: 'On Report Generated',
    candidatesNotificationFeishuChatId: 'Feishu Chat ID',
    candidatesNotificationFeishuChatIdPlaceholder: 'Leave empty for last active chat',
    candidatesNotificationFeishuChatIdHint: 'Specify a Feishu chat_id to send notifications to that group',
    candidatesNotificationConfigLoadError: 'Failed to load configuration',
    ...
    hinaCandidates: 'Hina Candidates',
    ...
    hinaCandidatesTab: 'Hina Candidates',
