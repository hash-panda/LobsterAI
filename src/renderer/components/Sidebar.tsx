...
import { MagnifyingGlassIcon, PuzzlePieceIcon, ClockIcon, UsersIcon } from '@heroicons/react/24/outline';
...
interface SidebarProps {
  onShowSettings: () => void;
  onShowLogin?: () => void;
  activeView: 'cowork' | 'skills' | 'scheduledTasks' | 'hinaCandidates';
  onShowSkills: () => void;
  onShowCowork: () => void;
  onShowScheduledTasks: () => void;
  onShowHinaCandidates: () => void;
  onNewChat: () => void;
  isCollapsed: boolean;
